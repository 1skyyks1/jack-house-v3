export const zhBase = {
  common: {
    ...
    loginRequiredDescription: "登录后即可继续访问当前页面。关闭登录框不会离开此页面。",
    networkError: "网络连接失败，请检查网络后重试。",
    permissionDenied: "你没有执行此操作的权限。",
    resourceNotFound: "请求的内容不存在或已被移除。",
...
export const enBase = {
  common: {
    ...
    loginRequired: "Sign in before continuing.",
    loginRequiredTitle: "Login required",
    loginRequiredDescription: "Sign in to continue on this page. Closing the login dialog will keep you here.",
    networkError: "Unable to connect. Check your network and try again.",
    permissionDenied: "You do not have permission to perform this action.",
    resourceNotFound: "The requested content does not exist or has been removed.",
