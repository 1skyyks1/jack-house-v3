export const zhAuth = {
  auth: {
    ...
    loggingIn: "登录中...",
    loginSuccess: "登录成功",
    sessionVerificationFailed: "登录已提交，但浏览器没有建立会话，请检查 Cookie 配置",
...
export const enAuth = {
  auth: {
    ...
    sessionVerificationFailed: "Login was accepted, but the browser did not establish a session. Check the cookie configuration.",
